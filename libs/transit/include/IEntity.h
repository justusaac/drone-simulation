...
class IEntity {
  ...
  */
  ...
  /**
   * @brief Make an IObserver recieve all of this entity's messages
   * @param observer A pointer to the observer that will recieve messages
   */
  virtual void attach(IObserver* observer);

  /**
   * @brief Remove any IObserver observing this entity
   */
  virtual void detach();

  /**
   * @brief Attempt to send a message to an attached IObserver
